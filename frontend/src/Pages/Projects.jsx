  ...
  return (
    ...
    <Hero />
      ...
      >
        ...
        >
          <path d="M12.04 2C6.48 2 2 6.48 2 12.04c0 1.77.46 3.45 1.32 4.95L2 22l5.01-1.32c1.5.86 3.18 1.32 4.95 1.32 5.56 0 10.04-4.48 10.04-10.04S17.6 2 12.04 2zm0 18.08c-1.55 0-3.05-.42-4.36-1.21l-.31-.19-2.97.78.79-2.89-.2-.3C4.2 15.05 3.8 13.6 3.8 12.04c0-4.52 3.72-8.24 8.24-8.24 4.52 0 8.24 3.72 8.24 8.24s-3.72 8.24-8.24 8.24zm4.49-6.17c-.25-.12-1.47-.73-1.69-.81-.23-.08-.39-.12-.56.12-.17.25-.64.81-.78.97-.14.17-.29.19-.54.06-.25-.12-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.02-.38.11-.51.11-.11.25-.29.37-.43.12-.14.17-.25.25-.41.08-.17.04-.31-.02-.43s-.56-1.34-.76-1.84c-.2-.48-.41-.42-.56-.43h-.48c-.17 0-.43.06-.66.31-.22.25-.86.85-.86 2.07 0 1.22.89 2.4 1.01 2.56.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.07.14-1.18s-.22-.16-.47-.28z" />
        </svg>
      </a>
    </>
  );
