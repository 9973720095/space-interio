...
const Projects = () => {
    ...
    const dummyProjects = [
      {
        ...
        gallery: [
          ...
          "https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=1200&auto=format&fit=crop",
          ...
          "https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1200&auto=format&fit=crop",
          ...
          "https://images.unsplash.com/photo-1616486029423-aaa4789e8c9a?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1618221381711-42ca8ab6e908?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1600607687920-4e2a09cf159d?w=1200&auto=format&fit=crop",
          ...
          "https://images.unsplash.com/photo-1600607687644-c7f34a43aba9?w=1200&auto=format&fit=crop",
        ],
      ...
      {
        id: 4,
        title: "Contemporary 3BHK Interior Design in Ghaziabad with Full Home Detailing",
        city: "Ghaziabad",
        bhk: "3-BHK",
        budget: "20-25 Lakhs",
        scope: "Full Home, Kitchen, Living Room",
        images: 16,
        img: "https://images.unsplash.com/photo-1618220179428-22790b461013?w=800&auto=format&fit=crop",
        gallery: [
          "https://images.unsplash.com/photo-1618220179428-22790b461013?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&auto=format&fit=crop",
      ...
      {
        id: 6,
        title: "Contemporary Interior Design of Villa in Delhi with Island Kitchen",
        city: "Delhi",
        bhk: "Villa",
        budget: "15-20 Lakhs",
      ...
      {
        id: 7,
        title: "2BHK Compact Home Design in Gurgaon with Smart Storage",
        city: "Gurgaon",
        bhk: "2-BHK",
        budget: "8-12 Lakhs",
        scope: "Bedroom, Living Room",
        images: 11,
        img: "https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=800&auto=format&fit=crop",
        gallery: [
          "https://images.unsplash.com/photo-1560448204-603b3fc33ddc?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1618220179428-22790b461013?w=1200&auto=format&fit=crop",
          "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&auto=format&fit=crop",
      ...
      {
        id: 8,
        title: "Luxury 4BHK Penthouse in Noida with Terrace Garden",
        city: "Noida",
        bhk: "4-BHK",
        budget: "50-60 Lakhs",
        scope: "Full Home, Terrace",
        images: 25,
      ...
      {
        id: 9,
        title: "Minimalist 1BHK Studio in Faridabad for Working Professionals",
        city: "Faridabad",
        bhk: "1-BHK",
        budget: "5-8 Lakhs",
        scope: "Full Home",
  ...
  <article className="project-card bg-white rounded-2xl shadow-lg overflow-hidden group hover:shadow-2xl transition-all duration-300">
    ...
    <div className="p-5">
      <h3
        className="text-lg font-bold mb-2 line-clamp-2 min-h-"
  ...
  return (
    <>
      <Helmet>
        <title>
          Delivered Projects - 500+ Home Interiors | Urbane Living Delhi NCR
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="home interior projects delhi, delivered homes gurgaon, 3bhk interior design noida, villa interior ghaziabad, interior design portfolio faridabad"
        />
        <link rel="canonical" href="https://urbaneliving.in/projects" />
        <meta
          property="og:title"
          content="500+ Delivered Home Interiors | Urbane Living"
        />
        <meta
          property="og:description"
          content="Browse our portfolio of luxury home interiors with 3D designs, pricing & real photos."
        />
        <meta
          property="og:image"
          content="https://urbaneliving.in/og-projects.jpg"
        />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "ItemList",
            name: "Delivered Interior Design Projects",
            description:
              "Portfolio of completed home interior projects in Delhi NCR",
            numberOfItems: projects.length + featured.length,
            itemListElement: [...featured,...projects]
          .slice(0, 10)
          .map((p, i) => ({
                "@type": "ListItem",
                position: i + 1,
                item: {
                  ...
                  name: p.title,
                  image: p.img,
                  description: `${p.bhk} interior design in ${p.city}`,
                  offers: {
                    "@type": "Offer",
                    price: p.budget,
                    priceCurrency: "INR",
